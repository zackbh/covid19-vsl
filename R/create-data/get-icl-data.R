###############################################################################
# Reads data from initial paper on lockdowns
## NB: Superseded by squire model
...
df <- left_join(df, select(readRDS(here::here("data/google-mobility.RDS")),-country_code, -country_name),
