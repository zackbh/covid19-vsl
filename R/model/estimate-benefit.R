###############################################################################
# Estimate benefit of lockdowns and other suppression policies -----
## Uses squire to estimate trajectory of epidemic at country level
...
wb <- readRDS(here::here("data/wb-data.RDS"))  # World Bank data
